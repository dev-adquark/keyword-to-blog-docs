    ...
    <DocsPageShell>
      <div className="max-w-prose">
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-5 font-body text-[15px] text-muted">
          ...
          <li>Deterministic validators then run once (the same categories as the evergreen pipeline, plus citation integrity and a hard backstop check that no link/citation markup survived). If a genuine problem remains, the request fails with <code className="font-mono">CONTENT_QUALITY_FAILED</code> — there is no second Anthropic call to try to fix it.</li>
        </ol>
