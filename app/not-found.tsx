...
export default function NotFound() {
  return (
    <main className="mx-auto flex max-w-6xl flex-col items-start px-6 py-28">
      ...
      <h1 className="mt-4 font-display text-3xl font-medium text-ink">This page doesn't exist</h1>
      <p className="mt-3 max-w-prose font-body text-[15px] text-muted">
        The route you requested isn't part of the Keyword-to-Blog API docs. Check the URL, or head
